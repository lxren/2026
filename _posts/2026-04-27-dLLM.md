...
<!-- GitHub preview version: renders on GitHub -->
![Masked Diffusion](../assets/img/2026-04-27-dLLM/MaskedDiffusion.png)

<!-- Jekyll blog submission version: renders on the blog -->
...
<!-- GitHub preview version: renders on GitHub -->
![Masked Diffusion](../assets/img/2026-04-27-dLLM/ForwardProcessA.png)

<!-- Jekyll blog submission version: renders on the blog -->
{% include figure.liquid path="assets/img/2026-04-27-dLLM/ForwardProcessA.png" class="img-fluid" %}

<!-- GitHub preview version: renders on GitHub -->
![Masked Diffusion](../assets/img/2026-04-27-dLLM/ForwardProcessB.png)
...
<!-- GitHub preview version: renders on GitHub -->
![Masked Diffusion](../assets/img/2026-04-27-dLLM/ReverseProcess.png)
...
<!-- GitHub preview version: renders on GitHub -->
![Masked Diffusion](../assets/img/2026-04-27-dLLM/TrainingPipeline.png)
...
<!-- GitHub preview version: renders on GitHub -->
![Masked Diffusion](../assets/img/2026-04-27-dLLM/StructuredInfilling.png)
...
<!-- GitHub preview version: renders on GitHub -->
![Masked Diffusion](../assets/img/2026-04-27-dLLM/DAEDAL.png)
...
<!-- GitHub preview version: renders on GitHub -->
![Masked Diffusion](../assets/img/2026-04-27-dLLM/ConfidenceLandscape.png)
...
<!-- GitHub preview version: renders on GitHub -->
![Masked Diffusion](../assets/img/2026-04-27-dLLM/ScalingLawsA.png)

<!-- Jekyll blog submission version: renders on the blog -->
{% include figure.liquid path="assets/img/2026-04-27-dLLM/ScalingLawsA.png" class="img-fluid" %}

<!-- GitHub preview version: renders on GitHub -->
![Masked Diffusion](../assets/img/2026-04-27-dLLM/ScalingLawsB.png)
...
<!-- GitHub preview version: renders on GitHub -->
![Masked Diffusion](../assets/img/2026-04-27-dLLM/Tweets.png)
...
Masked diffusion can be viewed as an any-order model, as it is trained to predict arbitrary masked subsets in any order. However in practice, left-to-right and right-to-left orders are easier to learn. This is due to the markovian nature of language, where conditioning on nearby tokens provides more predictive power. An any-order model wastes model capacity on modeling hard and unnatural orders. 
